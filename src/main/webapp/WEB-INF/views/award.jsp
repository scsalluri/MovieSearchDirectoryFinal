...
<form action="save_award">
    <table align="center" class="main-input" >
       <caption style="color: #fff; font-size: 30px; background-color: #bd0000"><strong>AWARD FORM</strong></caption>
        <tr>
          <td>
            
            <label style="margin:5px;color:#fff;" for="award">Award</label>
            <input required style="padding: 5px;" type="text" id="award" name="award" placeholder="Enter Award">
            <br>
            <br>
             <div class="c-btn">

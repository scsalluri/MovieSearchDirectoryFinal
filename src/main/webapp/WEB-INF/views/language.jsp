...
<form action="save_language">
    <table align="center" class="main-input" >
       <caption style="color: #fff; font-size: 30px; background-color: #bd0000"><strong>LANGUAGE FORM</strong></caption>
        <tr>
          <td>
            
            <label  style="margin:5px; color:#fff" for="language">Language</label>
             <input   style="padding: 5px;" type="text" id="language" name="language" placeholder="Enter Language"><br>

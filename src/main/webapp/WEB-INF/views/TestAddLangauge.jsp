				...
				<div class="d-flex justify-content-center form_container" >
					<form   method="POST" action="save-user"  >
						...
						<div class="input-group mb-3" >
							...
							<input type="text" name="username" class="form-control input_user"  placeholder="fullname">
						</div>
						...
						<div class="input-group mb-3" >
							...
							<input type="text" name="username" class="form-control input_user"  placeholder="email">
						</div>
						...
						<div class="input-group mb-3" >
							...
							<input type="password" name="password" class="form-control input_pass"  placeholder="re-enter password">
						</div>
						
				<div class="d-flex justify-content-center mt-4 login_container"  >
				 	<button type="submit" name="button" class="btn login_btn" value="Login" id="loginSubmit">Sign Up</button>
				</div>
			</form>
				</div>
